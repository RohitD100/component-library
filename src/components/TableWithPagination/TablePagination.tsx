        ...
        <tbody>
          {paginatedData.length === 0 ? (
            ...
            paginatedData.map((row) => (
              ...
              className={row.count % 2 === 1 ? "bg-white" : "bg-gray-50"}>
                {columns.map((col) => (
                  <td key={String(col.key)} className="px-4 py-2 text-sm text-gray-700 border-b border-gray-200">
        ...
        <ul className="flex space-x-2">
          <li>
            <button
              ...
              className={`px-3 py-1 rounded-md border text- ${
                currentPage === 1
